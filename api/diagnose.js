...
function buildSoloPrompt(d) {
  const f = d.fortune;
  return `あなたはよく当たると有名な占いライターです。以下のデータに基づいて、友達に話すようなわかりやすい言葉で運勢を伝えてください。専門用語（通変星、十二運、五行、相生、相剋など）は使わず、その意味を日常的な表現に置き換えてください。データにない情報は書かないでください。
...
function buildPairPrompt(d) {
  ...
  return `あなたはよく当たると有名な占いライターです。以下のデータに基づいて、友達に話すようなわかりやすい言葉で相性を伝えてください。専門用語（通変星、十二運、五行、相生、相剋など）は使わず、その意味を日常的な表現に置き換えてください。データにない情報は書かないでください。
