...
// 星ごとのラッキーフード（五行ベース）
// 五行ベースの食材系統（具体名ではなく系統で表記）
const STAR_FOODS = {
  1: {good: "甘味系・根菜類・黄色", kasai: "消化の良い物・温かい飲み物"},
  2: {good: "辛味系・発酵食品・白色", kasai: "乳酸菌系・身体を冷ます物"},
  3: {good: "苦味系・温まる物・赤色", kasai: "さっぱり系・柑橘系"},
  4: {good: "酸味系・葉野菜・香草系", kasai: "ハーブ系・木の実類"},
  5: {good: "塩味系・海産物・黒色", kasai: "温かい汁物・豆類"},
  6: {good: "渋味系・穀物類・紫色", kasai: "茶系の飲み物・雑穀類"},
};
...
言葉遣い: 専門用語は一切使わない。サイクル名（花・実・大殺界など）はそのまま使ってよいが、必ず意味を添えること。語尾は丁寧に「です」「ます」調とすること。
